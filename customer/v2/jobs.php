...
requireCustomer();
if (!customerCan('jobs')) { header('Location: /customer/v2/'); exit; }
...
<div class="flex items-start justify-between mb-6 flex-wrap gap-4">
  ...
  <a href="/customer/v2/booking.php" class="inline-flex items-center gap-2 px-5 py-3 bg-brand hover:bg-brand-dark text-white rounded-xl font-semibold text-sm shadow-sm transition">
...
<div class="card-elev p-5 flex flex-col sm:flex-row gap-5 transition">
  ...
  <div class="flex sm:flex-col items-end justify-between sm:justify-start sm:w-32 flex-shrink-0 pt-2 sm:pt-0">
    ...
    <div class="flex flex-col gap-2 mt-0 sm:mt-4 items-end">
      ...
      <a href="/customer/v2/booking.php?repeat=<?= (int) $j['j_id'] ?>" class="text-xs font-semibold text-gray-500 hover:text-brand flex items-center gap-1">
        ↻ Nochmal buchen
      </a>
      <?php endif; ?>
    </div>
