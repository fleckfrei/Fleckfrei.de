...
<div class="card-elev border-red-200 bg-red-50 p-5 mb-6 flex items-start gap-4">
  ...
  <a href="/customer/v2/invoices.php" class="flex-shrink-0 px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg text-sm font-semibold whitespace-nowrap">Jetzt bezahlen</a>
</div>
<?php endif; ?>
...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
  ...
  <a href="/customer/v2/booking.php" class="card-elev p-5 flex items-center justify-between hover:bg-brand-light group">
    <div>
...
<div class="card-elev p-6 mb-6 bg-gradient-to-br from-white to-brand-light relative overflow-hidden">
  ...
  <div class="relative z-10">
    ...
    <a href="/customer/v2/jobs.php" class="inline-flex items-center gap-2 text-sm font-semibold text-brand hover:text-brand-dark">
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
  <a href="/customer/v2/jobs.php" class="card-elev p-5 hover:border-brand transition">
  ...
  <a href="/customer/v2/invoices.php" class="card-elev p-5 hover:border-brand transition">
    <div class="text-2xl mb-2">🧾</div>
    <div class="font-semibold text-gray-900">Rechnungen</div>
    <div class="text-xs text-gray-500 mt-1">Zahlungen und Belege</div>
  </a>
  <a href="/customer/v2/messages.php" class="card-elev p-5 hover:border-brand transition">
    <div class="text-2xl mb-2">💬</div>
