...
h1 { color: #2E7D6B; font-size: 36px; text-align: center; margin: 40px 0; }
h2.slide-title { color: white; background: linear-gradient(135deg, #2E7D6B, #235F53); font-size: 22px; padding: 15px 20px; border-radius: 12px; margin: 30px 0 15px; }
h3 { color: #2E7D6B; font-size: 16px; margin: 15px 0 8px; }
li { font-size: 14px; margin: 4px 0; padding-left: 5px; }
ul { padding-left: 20px; }
code { background: #E8F5F1; color: #2E7D6B; padding: 2px 6px; border-radius: 3px; font-size: 13px; }
strong { color: #2E7D6B; }
