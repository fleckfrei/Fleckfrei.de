...
h1 { color: #2E7D6B; font-size: 28px; border-bottom: 3px solid #2E7D6B; padding-bottom: 10px; margin: 30px 0 15px; }
...
.cover h1 { font-size: 42px; border: none; color: #2E7D6B; }
.cover .subtitle { font-size: 18px; color: #666; margin-top: 10px; }
.cover .date { font-size: 14px; color: #999; margin-top: 30px; }
.cover .logo { width: 80px; height: 80px; background: #2E7D6B; color: white; font-size: 40px; font-weight: bold; border-radius: 20px; display: inline-flex; align-items: center; justify-content: center; margin-bottom: 20px; }
.btn { display: inline-block; padding: 12px 24px; background: #2E7D6B; color: white; border-radius: 8px; text-decoration: none; font-weight: bold; margin: 10px 5px; cursor: pointer; border: none; font-size: 14px; }
...
<?= $html ?>
<div style="margin-top:40px;padding-top:20px;border-top:2px solid #2E7D6B;text-align:center;color:#999;font-size:12px">
